...
def to_jaden_case(string):
    # This function splits the string into a list of words using space (' ')
    # as the parameter for the division. Then it capitalizes each element of
    # the list and then joins it again putting a space between each word.

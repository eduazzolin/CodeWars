...
count as part of a triplet (contributing to the 500 points) or as a single 50 points, but
not both in the same roll.
...
that you should never do. If you mutate the input, you will not be able to pass all the
tests.

KYU & CREDITS:
5 kyu JulianNicholls
...
public class Greed {
   public static int greedy(int[] dice) {
      ...
      int[] pointsThree = {1000, 200, 300, 400, 500, 600};
      int[] pointsOne = {100, 0, 0, 0, 50, 0};
      int total = 0;
